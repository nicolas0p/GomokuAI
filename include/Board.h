...
class Board {
	public:
		...
		~Board();
		void insert_move(std::pair<int, int> position, Moves move);
		void remove_move(std::pair<int, int> position, Moves move);
		Moves get_value_position(std::pair<int, int> position);
